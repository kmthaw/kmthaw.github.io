...
var type = new Typed(".auto",{
    strings: [ //multiple lines to be typed
       ...
       "I design webs using <strong>HTML,CSS</strong> and <strong>JS.</strong><br><br>I am also familiar with <strong>Python</strong>, <strong>Git</strong>.<br><br>Studying <strong> React, Vue</strong> and <strong>Angular</strong> at this moment as well.",
